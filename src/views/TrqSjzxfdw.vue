                        ...
                        <van-swipe-item>
                            <table class="table">
                                ...
                                <tr v-for="(item,index) in data1" :key="index">
                                    <td v-if="item.ZYQ002">{{item.ZYQ002}}</td>
                                    <td v-else>{{item.XSMC}}</td>
