        ...
        <div class="content2">
            <div class="plan">
                <div class="plan-item">
                    ...
                    <div class="plan-item-content">
                        <div class="plan-item-content-item">
                            <p class="p1">{{list4.RJH}}</p>
                            <p class="p2">日计划</p>
                        </div>
                        <div class="plan-item-content-item">
                            <p class="p1">{{list4.RYQL}}</p>
                            <p class="p2">日完成</p>
                        </div>
                        <div class="plan-item-content-item">
                            <p class="p1 cor1">{{list4.CQ}}</p>
                            <p class="p2">超欠</p>
                        </div>
                    </div>
                </div>
                <div class="plan-item">
                    ...
                    <div class="plan-item-content">
                        <div class="plan-item-content-item">
                            <p class="p1">{{list5.YJH}}</p>
                            <p class="p2">月计划</p>
                        </div>
                        <div class="plan-item-content-item">
                            <p class="p1">{{list5.YLQL}}</p>
                            <p class="p2">月累计</p>
                        </div>
                        <div class="plan-item-content-item">
                            <p class="p1 cor1">
                ...
                <div class="plan-item">
                    ...
                    <div class="plan-item-content">
                        <div class="plan-item-content-item">
                            <p class="p1">{{list6.NJH}}</p>
                            <p class="p2">年计划</p>
                        </div>
                        <div class="plan-item-content-item">
                            <p class="p1">{{list6.NLQL}}</p>
                            <p class="p2">年累计</p>
                        </div>
                        <div class="plan-item-content-item">
                            <p class="p1 cor1">
