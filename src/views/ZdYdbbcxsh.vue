            ...
            <div class="table-pad">
                <table class="cxsh-table" v-if="isTextshow">
                    ...
                    <tr v-for="(item,index) in list" :key="index">
                        ...
                        <td v-if="item.SPBZ=='（上报）'"><van-button type="warning" size="small" @click="cxsh(item.DWBH)">撤销审核</van-button></td>
...
export default {
    ...
    methods: {
        ...
        cxsh(TDW001){
            ...
            let year=startTime[0];
            let month=startTime[1];
            this.$axios.post('/ZDCancelYDBBSb',{
                TDW001,
                year,
                month
            }).then((res)=>{
