<template>
    <div class="yphgxx">
        ...
        <div class="content">
            ...
            <van-tabs :active="active2" color="#1f6eff" line-width="24%" title-active-color="#1d6fff" title-inactive-color="#434343" @change="changeTab2" key="tab2" v-else>
                <van-tab title="日报">
                    <van-list
                        v-model="loading2"
                        :finished="finished2"
    ...
    methods: {
        ...
        changeTab2(name,title){
            ...
            if(name==0){
                ...
                this.url2="/CPYXJBWeek"
            }else if(name==2){
                this.url2="/CPYXJBMonth"
            }else if(name==3){
                this.url2="/CPYXJBYear"
            }
            this.onLoad2()
        },
        //通知请求
