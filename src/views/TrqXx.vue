<template>
    <div class="trqxx">
        ...
        <div class="content">
            <van-tabs :active="active" color="#1f6eff" line-width="24%" title-active-color="#1d6fff" title-inactive-color="#434343" @change="changeTab" v-if="btnactive==0" key="tab1">
                <van-tab title="当天">
                    <van-list
                        v-model="loading"
                        :finished="finished"
                ...
                <van-tab title="更多">
                    ...
                    >
                        <div class="list-item">
                            <div class="item" v-for="(item,index) in list" :key="index">
                                <!-- <van-cell title="更多通知" :icon="icon4"  /> -->
                                <div class="content-plan">
                                    <div class="content-box" @click="xxxq(item.id)">
                                        <p class="p1" v-html="item.newsContent"></p>
                                        <p class="p2"><span>{{item.sendDatetime}}</span><van-icon name="arrow" /></p>
            ...
            <van-tabs :active="active2" color="#1f6eff" line-width="24%" title-active-color="#1d6fff" title-inactive-color="#434343" @change="changeTab2" v-else key="tab2">
                <van-tab title="日报">
                    <van-list
                        v-model="loading2"
                        :finished="finished2"
...
export default {
    ...
    methods: {
        ...
        changeTab2(name,title){
            ...
            this.flag2=false
            if(name==0){
                this.url2="/TRQYXJBDay"
            }else if(name==1){
                this.url2="/TRQYXJBWeek"
            }else if(name==2){
                this.url2="/TRQYXJBMonth"
            }else if(name==3){
                this.url2="/TRQYXJBYear"
            }
            this.onLoad2()
        },
        //通知请求
